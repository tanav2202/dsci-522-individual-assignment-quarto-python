...
Markdown(f"In @fig-horse-largest we zoom in and look at the province of **{largest_sd}**, which had the largest spread of values in terms of standard deviation.")
```
